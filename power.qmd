...
**Noise reduction is expressed as $R^2$**, the share of outcome variance explained by your blocking variables or covariates. Adjusting for covariates reduces the residual SD to $\sigma\sqrt{1-R^2}$, which raises $d$ by the reciprocal of that factor, $1/\sqrt{1-R^2}$. This is why the effect-size and noise cards above are two views of one lever: only the ratio $\delta/\sigma$ matters. Pre-treatment measures of the outcome itself are usually the most powerful covariates available — the statistical argument for a pre-test.
